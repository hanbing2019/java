 ...
 * 
 */
@WebServiceClient(name = "FunctionService", targetNamespace = "http://webservice/", wsdlLocation = "http://localhost:9001/Service/Function?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FUNCTIONSERVICE_QNAME = new QName("http://webservice/", "FunctionService");
    ...
    public Function getFunctionPort() {
        return super.getPort(new QName("http://webservice/", "FunctionPort"), Function.class);
    }
    ...
    public Function getFunctionPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice/", "FunctionPort"), Function.class, features);
    }
