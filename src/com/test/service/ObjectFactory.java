...
public class ObjectFactory {
    ...
    private final static QName _TransWordsResponse_QNAME = new QName("http://webservice/", "transWordsResponse");
    private final static QName _TransWords_QNAME = new QName("http://webservice/", "transWords");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "transWordsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice/", name = "transWords")
